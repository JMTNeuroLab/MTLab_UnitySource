...
//-----------------------------------------------------------------------
// Created a copy of the "EyeTracker" class from tobii to make some private variables
// public. 
...
public class TobiiEyeTracker : EyeTrackerBase
{
    ...
    public bool _connectToFirst = true;
    ...
    public string _eyeTrackerSerialStart = "IS";
